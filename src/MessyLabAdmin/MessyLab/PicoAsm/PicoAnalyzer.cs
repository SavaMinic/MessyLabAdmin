...
namespace MessyLab.PicoComputer {
     ...
     * parser.</remarks>
     */
    internal abstract class PicoAnalyzer : Analyzer {
        ...
        public override Node Exit(Node node) {
            ...
            case (int) PicoConstants.BEQ:
                return ExitBeq((Token) node);
            case (int) PicoConstants.BGT:
                return ExitBgt((Token) node);
            case (int) PicoConstants.IN:
                return ExitIn((Token) node);
            case (int) PicoConstants.OUT:
                return ExitOut((Token) node);
            case (int) PicoConstants.JSR:
                return ExitJsr((Token) node);
            case (int) PicoConstants.RTS:
                return ExitRts((Token) node);
            case (int) PicoConstants.STOP:
            ...
            case (int) PicoConstants.ARITHMETIC:
                return ExitArithmetic((Production) node);
            case (int) PicoConstants.BRANCH:
                return ExitBranch((Production) node);
            case (int) PicoConstants.IO:
                return ExitIo((Production) node);
            case (int) PicoConstants.CALL:
                return ExitCall((Production) node);
            case (int) PicoConstants.RETURN:
                return ExitReturn((Production) node);
            case (int) PicoConstants.END:
                return ExitEnd((Production) node);
            case (int) PicoConstants.MOVE_ARGS:
                return ExitMoveArgs((Production) node);
            case (int) PicoConstants.ARITHMETIC_ARGS:
                return ExitArithmeticArgs((Production) node);
            case (int) PicoConstants.BRANCH_ARGS:
                return ExitBranchArgs((Production) node);
            case (int) PicoConstants.IOARGS:
                return ExitIoargs((Production) node);
            case (int) PicoConstants.END_ARGS:
                return ExitEndArgs((Production) node);
            case (int) PicoConstants.ARG12:
                return ExitArg12((Production) node);
            case (int) PicoConstants.ARG34:
                return ExitArg34((Production) node);
            case (int) PicoConstants.ARG123:
                return ExitArg123((Production) node);
            case (int) PicoConstants.ARG1234:
                return ExitArg1234((Production) node);
            case (int) PicoConstants.ARG1:
                return ExitArg1((Production) node);
            case (int) PicoConstants.ARG2:
                return ExitArg2((Production) node);
            case (int) PicoConstants.ARG3:
                return ExitArg3((Production) node);
            case (int) PicoConstants.ARG4:
                return ExitArg4((Production) node);
            }
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterMov(Token node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitMov(Token node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterBeq(Token node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitBeq(Token node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterBgt(Token node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitBgt(Token node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterJsr(Token node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitJsr(Token node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterRts(Token node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitRts(Token node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterMove(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitMove(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildMove(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterArithmetic(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitArithmetic(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildArithmetic(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterBranch(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitBranch(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterIo(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitIo(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildIo(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterReturn(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitReturn(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterEnd(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitEnd(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildEnd(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterMoveArgs(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitMoveArgs(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterArithmeticArgs(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitArithmeticArgs(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterBranchArgs(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitBranchArgs(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildBranchArgs(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterIoargs(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitIoargs(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildIoargs(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterEndArgs(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitEndArgs(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildEndArgs(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterArg12(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitArg12(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildArg12(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterArg34(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitArg34(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildArg34(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterArg123(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitArg123(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildArg123(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterArg1234(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitArg1234(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterArg1(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitArg1(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildArg1(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterArg2(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitArg2(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildArg2(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterArg3(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitArg3(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildArg3(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterArg4(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitArg4(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildArg4(Production node, Node child) {
            node.AddChild(child);
        }
    }
}
