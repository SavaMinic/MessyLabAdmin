...
namespace MessyLab.PicoComputer
{
    ...
    /// <summary>
	/// This exception can be thrown by a IO device when there is no more input
	/// </summary>
	public class EmptyInputRuntimeException : RuntimeException
    {
        ...
        public override string Message
        {
            get { return "Given input is empty, can't read from input."; }
        }
    }

    /// <summary>
    /// This exception can be thrown by a IO device, when the actual output doesn't match expected output
    /// </summary>
    public class ExpectedOutputMismatchRuntimeException : RuntimeException
    {
        public ExpectedOutputMismatchRuntimeException() : base(new ushort[] { 0 }, 0) { }
        ...
        public override string Message
        {
            get { return "Actual output is different than expected output."; }
        }
    }
}
